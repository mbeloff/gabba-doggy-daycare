    ...
    <div class="bg-gray-900">
        ...
        <div class="bg-gray-100 grid">
            <button
                ...
                class="text-center justify-self-center link-pink py-1 m-1"
                @click="slideList()"
            >
                <i class="fal fa-redo-alt mr-2"></i>show me more GDDC superstars
            </button>
        </div>
    </div>
</template>
    ...
    data() {
        return {
            ...
            slides: [
                ...
                '/photos/03_22b/8.jpg',
                '/photos/03_22b/9.jpg',
                '/photos/03_22b/10.jpg',
                '/photos/03_22b/11.jpg',
                '/photos/03_22b/12.jpg',
                '/photos/03_22b/13.jpg',
                '/photos/03_22b/14.jpg',
                '/photos/03_22b/15.jpg',
                '/photos/03_22b/16.jpg',
                '/photos/03_22b/17.jpg',
                '/photos/03_22b/18.jpg',
                '/photos/03_22b/19.jpg',
                '/photos/03_22b/20.jpg',
                '/photos/03_22b/21.jpg',
                '/photos/03_22b/22.jpg',
                '/photos/03_22b/23.jpg'
            ],
            list: []
        }
    },
