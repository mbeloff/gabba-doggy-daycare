<template>
  <div
    class="px-2 py-20 mx-auto max-w-screen-lg"
    id="prices"
  >
          ...
          <div class="grid grid-cols-1 pt-5 gap-x-10 text-sm ">
            ...
            >
              <div
                ...
                :class="{ 'taxi cursor-pointer' : extra.selector == 'taxi' }"
              >
                <div
                  class="flex-grow px-2"
                  :class="{ 'opacity-50' : extra.soon == '- available soon'}"
                >{{extra.name}} <span class="text-pink-500">{{ extra.soon }}</span></div>
