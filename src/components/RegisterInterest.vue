<template>
  <div class="p-3">
      <p class="text-blue-900">Thanks for checking out Gabba Doggy Day Care. We're opening December 1. Leave your details and we'll let you know how to book in for you free trial.</p>
      <br />
