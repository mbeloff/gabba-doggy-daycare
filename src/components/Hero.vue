  ...
  <div class="hero-grid grid grid-cols-1 lg:grid-cols-4 lg:grid-rows-1 bg-gray-200">
    <div class="grid p-10 lg:py-40 sm:px-40 2xl:px-60 order-2 lg:order-1 col-span-2">
      <div class="place-self-center space-y-3">
        <p class="mb-5 text-xl md:text-2xl"><span class="font-bold text-yellow-500 uppercase">Try us out for $10</span> For a limited time, all new accounts get their first day at Gabba Doggy Daycare for only $10.</p>
       <router-link to="Sign-up" class="btn-blue text-xl w-full block text-center"> Sign me up!</router-link>
       <p class="text-gray-500">Please note: We will be closed from <span class="font-bold">Dec 24 - Jan 5</span> <i class="fad fa-candy-cane text-red-500"></i><i class="fad fa-holly-berry text-green-500"></i></p>
      </div>
    </div>
...
.hero-pup {
  ...
  @media only screen and (max-width: 400px) {
    background-image: url(https://res.cloudinary.com/dg5ybbkbh/image/upload/c_fit,w_320/v1/gddc/hero-pup-full.jpg);
  }
}
</style>
