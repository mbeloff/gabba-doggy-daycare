<template>
  <div class="p-3">
    <p class="text-blue-900">Login to PetExec here to manage your account, schedule daycare or buy packages. <span v-if="!isSignUp()">If you don't have an account yet, you can create one <a href="javascript:void(0)" @click="close" class="link-pink" title="new account page">here.</a></span> </p>
    <br />
