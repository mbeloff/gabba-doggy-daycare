<template>
  <div class="container mx-auto max-w-screen-lg py-20 px-2">
    ...
    <div class="text-sm mb-3">
      ...
      <ul class="list-inside list-none flex flex-col gap-3">
        <li>
          <span class="font-bold">Socialisation -</span> Your dog will have a great chance to socialise, mingle and play with new dogs and humans! We separate dogs based on their size and temperament and do our best to ensure dogs are with others that they will get along with.
        </li>
        <li>
