...
<div class="container mx-auto">
   <div class="px-3 mx-auto my-10 leading-7 text-justify text-gray-700 lg:text-left lg:px-20">
    ...
    <p>
      ...
      website or Service and tells You about Your privacy rights and how the law
      protects You.
    </p>
    <p>
      We use Your Personal data to provide and improve the Service. By using the
      website or Service, You agree to the collection and use of information in
    ...
    <ul class="pl-6 list-disc list-outside">
      ...
      <li>
        ...
        <p>
          ...
          use the Website, such as remembering your form data or language
    ...
    <ul class="pl-6 list-disc list-outside">
      ...
      <li>
        <p>
          <strong>To manage Your Account:</strong> to manage Your usage of our
          Service. The Personal Data You provide is used to facilitate usage and
    ...
    <ul class="pl-6 list-disc list-outside">
      ...
      <li>
        ...
        or otherwise interact in the public areas, such as product or service
        reviews, such information may be viewed by all users and may be publicly
