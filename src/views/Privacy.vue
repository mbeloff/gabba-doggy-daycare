<template>
  <div class="mx-auto px-3 my-10 text-justify lg:text-left w-full sm:w-2/3 md:w-1/2 lg:w-2/5">
    ...
    <p>Gabba Doggy Daycare is commited to providing quality services and care to you and your pets. To this end we may obtain Personal Information from you. This policy outlines our obligations to you with respect to how we manage this information.</p>
    ...
    <p>A copy of the Australian Privacy Principles may be obtained from the website of The Office of the Australian Information Commissioner at www.aoic.gove.au,</p>
    ...
    <p>This Personal Information may be obtained in person, via phone, email, our website www.gabbadoggydaycare.com, and from third parties. We cannot guarantee policies of authorised third parties.</p>
    ...
    <p>Your Personal Information may be disclosed in several circumstances including:</p>
    ...
    <p>Gabba Doggy Day Care will not charge any fee for your access request but may charge an administrative fee for providing a copy of your Personal Information.</p>
    ...
    <p>It is an important to us that Personal Information required by us to provide our services is up to date. We  will  take reasonable steps to make sure that your Personal Information is accurate, complete and up-to-date. If you find that the information we have is not up to date or is inaccurate, please advise us as soon as practicable so we can update our records and ensure we can continue to provide quality services to you.</p>
    <h2>Policy Updates</h2>
    <p>This Policy may change from time to time and is available on our website (www.gabbadoggydaycare.com).</p>
    <h2>Privacy Policy Complaints and Enquiries</h2>
    <p>If you have any queries or complaints about our Privacy Policy please contact by mail at:</p>
    <p>Gabba Doggy Day Care <br>
    46 Deshon St, <br>
