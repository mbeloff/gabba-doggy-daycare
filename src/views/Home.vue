...
export default {
    ...
    metaInfo: {
        ...
        jsonld: {
            ...
            image:
                'https://res.cloudinary.com/dg5ybbkbh/image/upload/v1607553601/gddc/photos/03.jpg',
            logo:
                'https://www.gabbadoggydaycare.com/img/gddc-logo.02c7187e.svg',
            aggregateRating: {
            ...
            features: [
                {
                    ...
                    icon: 'calendar-day',
                    desc:
                        'Sign up online to conveniently manage your bookings, update your information or purchase our discount daycare packages.'
                },
                {
                    title: 'Dogs of all Shapes and Sizes',
                    icon: 'paw',
                    desc:
                        "With dedicated areas for both older dogs and puppies, and play areas separated by size and temperament. There's a place for everyone at GDDC."
                },
                {
                    title: 'Sunshine and Grass',
                    icon: 'sunglasses',
                    desc:
                        'Stimulating environment with spacious indoor areas, and huge outdoor play areas with grass, pools and sand pits.'
                },
                {
                    title: 'Pet Taxi',
                    icon: 'taxi',
                    desc:
                        'Save yourself some running around - our pet taxi is available for local pickup and dropoff.'
                },
                {
                    title: 'Grooming',
                    icon: 'bath',
                    desc:
                        'Basic washes, nail clips and ear cleans available through the week, so you can have you pup coming home fresh and clean.'
                }
            ]
        }
    },
