<template>
  <div>
    <div class="section">
      <div class="container py-20 mx-auto max-w-screen-lg">
        ...
        <div class="w-full p-3 mx-auto leading-7 text-left text-gray-700 md:w-3/4 lg:w-2/3">
          <section-signup></section-signup>
          <choose-location class="mt-10"></choose-location>
          <div class="mt-10 text-center">
            <a :href="link" target="_blank" rel="noopener" class="inline-block btn-blue">Create an Account</a>
          </div>
