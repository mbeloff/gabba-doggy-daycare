        ...
        <div class="section">
            <div class="container max-w-screen-lg px-2 py-20 mx-auto">
                ...
                <div class="grid grid-cols-1 gap-x-20 md:grid-cols-2">
                    <div
                        class="flex flex-col justify-between text-left md:col-span-1"
                    >
                        ...
                        >
                            ...
                            <label
                                ...
                                ><input
                                    ...
                                    v-model="agree"
                                    class="hidden"
                                />I acknowledge the above and assert that my dog
                                has not bitten, or shown aggression to another
                                animal or person</label
                            >
                        </div>

                        <div
                            class="my-10 text-center col"
                            @click="checkAgree()"
                        >
                            <a
                                href="https://book.collar.pet/au/brands/gabba-doggy-daycare/forms/?form=enrolment-"
